package nomad.strat.service.persistence.dal

import nomad.strat.service.persistence.entities.BaseTable
import nomad.strat.service.rest.BaseEntity
...
class BaseDalImpl[T <: BaseTable[A], A <: BaseEntity](tableQ: TableQuery[T])(implicit val db: JdbcProfile#Backend#Database,implicit val profile: JdbcProfile) extends BaseDal[T,A] {
